...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [69.148906, 34.504720, 69.212663, 34.545336], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            extent: [69.148906, 34.504720, 69.212663, 34.545336],
            units: 'degrees'})
    })
});


map.getView().fit([69.148906, 34.504720, 69.212663, 34.545336], map.getSize());
